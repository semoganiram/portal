...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link type="text/css" rel="stylesheet" media="screen" href="style_calculadora.css" />
                                        ...
                                        <div id="calc_borda_conteudo">
                                            ...
                                            <div id="calc_conteudo_forms">
                                             <form method="post" action="calc_dados.php">
                                              ...
                                              <input type="reset" name="clear" value="Limpar" class="btnlimpar"/>
                                              <input type="submit" name="submit" value="Calcular" class="btncalcular"/>
                                                </form>
